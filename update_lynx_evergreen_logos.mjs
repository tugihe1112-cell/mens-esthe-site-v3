...
async function run() {
  ...
  // 新規2店舗の検索キーワードとロゴURLのペア
  const logoSettings = [
    { 
      searchKeywords: ['lynx', 'リンクス'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/Lynx.png' 
    },
    { 
      searchKeywords: ['evergreen', 'エバーグリーン'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/evergreen.png' 
    }
  ];

  try {
    console.log(`🚀 新規2店舗のロゴ一括設定を開始します（全系列店対応版）...\n`);
