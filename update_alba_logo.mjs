...
async function run() {
  ...
  // アルバTOKYOの検索キーワードとロゴURL
  const searchKeywords = ['alba tokyo', 'アルバtokyo', 'アルバ'];
  const logoUrl = 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/alba%20tokyo.png';

  try {
    console.log(`🚀 「アルバTOKYO」のロゴ設定を開始します...\n`);
