      ...
      <>
        ...
        <div className="min-h-screen bg-slate-950 pt-24 pb-12 px-4 relative overflow-hidden">
          ...
          <div className="max-w-md mx-auto relative z-10">
            <div className="bg-slate-900/40 backdrop-blur-xl rounded-3xl md:rounded-[2.5rem] p-6 md:p-10 border border-white/10 text-center shadow-2xl">
              ...
              <div className="mb-8">
                <h1 className="text-2xl font-black text-white mb-2 tracking-tight">マイページ</h1>
    ...
    <>
      ...
      <div className="min-h-screen bg-slate-950 pt-24 pb-12 px-4">
        <div className="max-w-lg mx-auto space-y-6">
          <div className="bg-slate-900/40 backdrop-blur-xl rounded-3xl md:rounded-[2.5rem] p-6 md:p-8 border border-white/10 relative overflow-hidden group">
