    ...
    <div className="min-h-screen bg-slate-950 pb-32 text-slate-200 font-sans">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-12">
        ...
        <div className="bg-slate-900/50 backdrop-blur rounded-2xl border border-white/5 p-6 md:p-8 shadow-xl space-y-8 text-sm md:text-base leading-relaxed text-slate-300">
          ...
          <section>
            <h2 className="text-lg font-bold text-white mb-3">第3条（運営者による投稿の明示）</h2>
            <p>1. 本サービスに掲載されるクチコミ・体験レポートには、ユーザーによる投稿のほか、本サービスの運営者自身が実際に店舗を利用した体験に基づいて作成・投稿したもの（以下「運営者投稿」といいます。）が含まれます。</p>
            <p>2. 運営者投稿は、運営者が自らの体験に基づき作成したものであり、店舗からの依頼または対価の受領に基づくものではありません。景品表示法その他の関係法令（いわゆるステルスマーケティング規制を含みます。）の趣旨に鑑み、運営者による投稿が含まれる旨を、本条によりあらかじめ包括的に開示します。</p>
            <p>3. 運営者投稿は、書き手の一貫した視点を示すため、ペンネーム（筆名）を用いて表示される場合があります。ペンネームによる表示は、当該投稿が運営者自身の実体験に基づくものであることを否定するものではなく、本条に定める開示の対象に含まれます。</p>
          </section>
          ...
          <section>
            <h2 className="text-lg font-bold text-white mb-3">第5条（プレミアムサービス・有料プラン）</h2>
            <p>1. 現在、本サービスは有料プランの申込みおよび決済を受け付けていません。</p>
            <p>2. 有料プランを開始する場合は、料金、提供内容、支払時期、解約・返金条件その他必要な事項を、申込み前に購入画面および「特定商取引法に基づく表記」で明示します。</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-white mb-3">第6条（規約の変更）</h2>
