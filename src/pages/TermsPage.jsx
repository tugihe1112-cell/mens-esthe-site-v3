      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-slate-900/50 backdrop-blur rounded-2xl border border-white/5 p-6 md:p-8 shadow-xl space-y-8 text-sm md:text-base leading-relaxed text-slate-300">
          ...
          <section>
            ...
            <p>2. 運営者投稿は、運営者が自らの体験に基づき作成したものであり、店舗からの依頼または対価の受領に基づくものではありません。景品表示法その他の関係法令（いわゆるステルスマーケティング規制を含みます。）の趣旨に鑑み、運営者による投稿である旨を明示します。運営者投稿には、その旨が分かる表示を付します。</p>
          </section>
