...
//    **文字列で**探していた。戻り先の検証を src/utils/authRedirect.js へ一本化した際に
...
try {
  const { normalizeReturnTo } = await import('../../src/utils/authRedirect.js');
  ...
  violations.push(`src/utils/authRedirect.js を読み込めません: ${error.message}`);
}
