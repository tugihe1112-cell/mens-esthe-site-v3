...
async function run() {
  ...
  const logoSettings = [
    { 
      ...
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/aroma%20maison.png' 
    },
    { 
      searchKeywords: ['lumespa', 'ルメスパ', 'aroma spec'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/lume%20spa.png' 
    }
  ];

  try {
    console.log(`🚀 「Aroma Maison」と「ルメスパ」のロゴ設定を開始します...\n`);
