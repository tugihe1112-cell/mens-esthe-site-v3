...
async function run() {
  ...
  const logoSettings = [
    { 
      ...
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/aria.png' 
    },
    { 
      searchKeywords: ['royal spa', 'ロイヤルスパ'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/royal%20spa.png' 
    }
  ];

  try {
    console.log(`🚀 「ARIA」と「Royal Spa」のロゴ設定を開始します...\n`);
