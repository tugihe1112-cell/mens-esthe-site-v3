...
async function run() {
  ...
  const logoSettings = [
    { 
      ...
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/be-majo.png' 
    },
    { 
      searchKeywords: ['za-gin', 'ザギン', 'the gin'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/THE%20GIN.png' 
    }
  ];

  try {
    console.log(`🚀 「be-majo」と「THE★GIN」のロゴ設定を開始します...\n`);
