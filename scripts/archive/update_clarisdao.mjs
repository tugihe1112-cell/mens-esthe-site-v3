...
async function run() {
  ...
  // クラリスDAOのデータ定義
  const shopDef = {
    // 誤爆を防ぐため、キーワードを複数指定して精度を上げる
    searchKeywords: ['クラリスdao', 'clarisdao', 'クラリスダオ'],
    website_url: "https://fujoho.jp/index.php?p=shop_info&id=57056", // スケジュールURLと同じに設定
    schedule_url: "https://fujoho.jp/index.php?p=shop_info&id=57056",
    price_system: "60分: 13,000円→11,000円(ネット指名料込み) 新規フリー10,000円\n90分: 15,000円→13,000円(ネット指名料込み) 新規フリー12,000円\n120分: 19,000円→16,000円(ネット指名料込み) 新規フリー15,000円\n150分: 24,000円→20,000円(ネット指名料込み)\n180分: 32,000円→27,000円(ネット指名料込み)",
    casts: [
  ...
  try {
    console.log(`🔍 データベースから「クラリスDAO」を検索し、一括更新を実行します...\n`);
