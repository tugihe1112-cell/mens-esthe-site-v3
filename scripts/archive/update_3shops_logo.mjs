...
async function run() {
  ...
  const logoSettings = [
    { 
      ...
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/kanoneko.png' 
    },
    { 
      searchKeywords: ['rains rapt', 'レインズラプト'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/rainsrapt.png' 
    },
    { 
      searchKeywords: ['rhea spa', 'レアスパ'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/rhea%20spa.png' 
    }
  ];

  try {
    console.log(`🚀 「カノネコ」「Rains Rapt」「RHEA SPA」のロゴ設定を開始します...\n`);
