...
async function run() {
  ...
  const logoSettings = [
    { 
      ...
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/anna.png' 
    },
    { 
      searchKeywords: ['aroma abc', 'アロマabc'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/aroma%20abc.png' 
    }
  ];

  try {
    console.log(`🚀 「ANNA」と「Aroma ABC」のロゴ設定を開始します...\n`);
