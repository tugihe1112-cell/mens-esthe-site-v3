...
const AREA_ID = 'unknown'; // ※エリア不明のため仮設定
const SHOP_ID = `${AREA_ID}_spa_flame`; 
...
async function main() {
  console.log('🚀 「スパフレイム (Spa Flame)」の店舗とセラピスト登録を開始します...\n');
  ...
  try {
    ...
    items.each((_, el) => {
      ...
      // <p class="girl_info">つむぎさん<br>42歳 身長 165cm<br></p> から情報を抽出
