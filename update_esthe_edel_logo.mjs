...
async function run() {
  ...
  const logoSettings = [
    { 
      ...
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/the%20este%20azabu.png' 
    },
    { 
      searchKeywords: ['edel', 'エデル麻布', 'エデル'], 
      logo: 'https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/edel%20azabu.png' 
    }
  ];

  try {
    console.log(`🚀 「THE ESTHE AZABU」と「EDEL AZABU」のロゴ設定を開始します...\n`);
