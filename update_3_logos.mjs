...
async function run() {
  ...
  const logoUpdates = [
    {
      keywords: ["Chocolate", "チョコレート"],
      image_url: "https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/Chocolate.png"
    },
    {
      keywords: ["Silk", "シルク"],
      image_url: "https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/silk.png"
    },
    {
      keywords: ["KIWAMI TOKYO", "極楽エステ"],
      image_url: "https://azuetkuzzmshqfbrhqmf.supabase.co/storage/v1/object/public/shop-logos/kiwami.png"
    }
  ];
